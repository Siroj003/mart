...
export const Testimonial = () => {
	...
	return (
		<section id="testimonials" className={`${styles.testimonial} container-fluid`}>
			<div className="container">
				...
				<div className={styles.title}>
					...
					<div className={styles.titleRight}>
						<div>
							<h2>25+</h2>
							<span>Winning award best <br /> shipping company</span>
						</div>
						<div>
							<h2>100k+</h2>
							<span>Happy customers <br /> around the world</span>
						</div>
					</div>
				</div>
